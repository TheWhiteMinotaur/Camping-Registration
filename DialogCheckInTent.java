...
public class DialogCheckInTent extends JDialog implements ActionListener{
	...
	/* JLabels */
	private JLabel nameLabel, occupyingLabel, stayingLabel, 
	siteLabel, tentersLabel;
		...
		if (e.getSource() == okButton) {
			if (check()) {
				...
				JOptionPane.showMessageDialog(null, "There are empty "
						+ "fields. Please populate all fields"
						+ " with values");
			}
		}
	...
	private void checkFields() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,"Number of tenters"
					+ " must be an integer. Please enter an integer.");
			isValid = false;
		}
